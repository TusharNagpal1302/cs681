...
public class PrimeFactorizer {
	...
	public static void main(String[] args) {
		...
		System.out.print("Prime factors of 28: ");
		fac = new PrimeFactorizer(28);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());

		System.out.print("Prime factors of 193: ");
		fac = new PrimeFactorizer(193);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());

		System.out.print("Prime factors of 94: ");
		fac = new PrimeFactorizer(94);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());

		System.out.print("Prime factors of 1107: ");
		fac = new PrimeFactorizer(1107);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
